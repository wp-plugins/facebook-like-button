...
$SDK = '<div id="fb-root"></div>
   ...
   $xfbml = '<div class = "'.$CSS.'"  style = "height: 37px"><fb:like href="'.$url.'" layout="'.$Layout.'" show_faces="'.$face.'" width="'.$Width.'" action="'.$verb.'" colorscheme="'.$color.'" /></div><br>';
   $iframe = ' 
   <div class = "'.$CSS.'" style = "height: 37px"><iframe src="http://www.facebook.com/plugins/like.php?href='.$url.'"&layout='.$Layout.'&show_faces='.$face.'&width='.$Width.'&action='.$verb.'&colorscheme='.$color.'" scrolling="no" frameborder="0" allowTransparency="true" style="border:none; overflow:hidden; width:450px; height:px"></iframe></div><br>';
